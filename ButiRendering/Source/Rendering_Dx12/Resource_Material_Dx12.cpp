...
ButiEngine::ButiRendering::Resource_Material_Dx12::Resource_Material_Dx12(const MaterialValue & arg_var, Value_weak_ptr<IResource_Shader> arg_vlp_shader, const List< Value_ptr<IResource_Texture>>& arg_list_texture, Value_weak_ptr<GraphicDevice_Dx12> arg_vwp_graphicDevice)
	: Resource_Material(arg_var, arg_vlp_shader,arg_list_texture),  m_vwp_graphicDevice(arg_vwp_graphicDevice) {}
...
ButiEngine::Value_ptr<ButiEngine::ButiRendering::IResource_Material> ButiEngine::ButiRendering::CreateMaterial(const MaterialValue& arg_var, Value_weak_ptr<IResource_Shader> arg_vlp_shader, Value_ptr<IResource_Texture> arg_texture, Value_weak_ptr<GraphicDevice> arg_vwp_graphicDevice)
{
	return CreateMaterial(arg_var,arg_vlp_shader, { arg_texture }, arg_vwp_graphicDevice);
}
ButiEngine::Value_ptr<ButiEngine::ButiRendering::IResource_Material> ButiEngine::ButiRendering::CreateMaterial(const MaterialValue& arg_var, Value_weak_ptr<IResource_Shader> arg_vlp_shader, const List<Value_ptr<IResource_Texture>>& arg_list_texture, Value_weak_ptr<GraphicDevice> arg_vwp_graphicDevice)
{
	return ObjectFactory::Create<ButiRendering::Resource_Material_Dx12>(arg_var, arg_vlp_shader,arg_list_texture, arg_vwp_graphicDevice.lock()->GetThis<GraphicDevice_Dx12>());
}
...
{
	return ObjectFactory::Create<ButiRendering::Resource_MaterialList_Dx12>(arg_var, arg_vlp_shader, arg_list_texture, arg_list_material,arg_vwp_graphicDevice.lock()->GetThis<GraphicDevice_Dx12>());
}
