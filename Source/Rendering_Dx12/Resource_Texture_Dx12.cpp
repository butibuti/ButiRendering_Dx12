#include"stdafx.h"
#include"../../Header/Rendering_Dx12/GraphicResourceUtil_Dx12.h"
...
ButiEngine::GUIWindowReaction ButiEngine::ButiRendering::Resource_Texture_Dx12::ShowTextureWindow(const std::string& arg_windowName,const std::int32_t winFrag)
{
	GUI::SetNextWindowSize(Vector2(500, 500), GUI::GuiCond_FirstUseEver);
...
void ButiEngine::ButiRendering::Resource_Texture_Dx12::ShowGUI()
{
	...
	auto output = ShowTextureWindow("", 0);
	if (output.isClosed) {
		UnRegistEditorGUI();
	}
	GUI::PopStyleVar(3);
