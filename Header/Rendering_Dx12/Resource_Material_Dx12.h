...
{
public:
	BUTIRENDERING_API Resource_Material_Dx12(const MaterialValue& arg_var, Value_ptr<IResource_Shader> arg_vlp_shader, const List< Value_ptr<IResource_Texture>>& arg_list_texture, const DrawSettings& arg_drawSettings, Value_weak_ptr<GraphicDevice_Dx12> arg_vwp_graphicDevice);
...
public:
	BUTIRENDERING_API Resource_MaterialList_Dx12(const MaterialValue& arg_var, Value_ptr<IResource_Shader> arg_vlp_shader, const List< Value_ptr<IResource_Texture>>& arg_list_texture, const List<Value_ptr<IResource_Material>>& arg_list_material, const DrawSettings& arg_drawSettings, Value_weak_ptr<GraphicDevice_Dx12> arg_vwp_graphicDevice);
	BUTIRENDERING_API void Initialize()override;
	BUTIRENDERING_API void Attach()override;
	BUTIRENDERING_API void Update()override;
	BUTIRENDERING_API std::uint32_t GetTextureCount()const override;
