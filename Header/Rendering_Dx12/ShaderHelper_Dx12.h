...
public:
	...
	static void OutputCereal(const std::vector<ShaderElement>& v, const std::string& arg_path);
	static void InputCereal(std::vector<ShaderElement>& v, const std::string& arg_path);
